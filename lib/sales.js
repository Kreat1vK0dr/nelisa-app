...
exports.home = function (req, res, next) {
    ...
    req.services(function (err, services) {
        ...
        saleService.getAllSalesDetails()
            .then(function (sales) {
...
exports.search = function (req, res, next) {
    ...
    req.services(function (err, services) {
        ...
        if (searchEmpty) {
            ...
            saleService.searchSalesDetailsByProduct([search])
                .then(function (sales) {
            ...
            saleService.searchSalesDetailsByCategory([search])
                .then(function (sales) {
            ...
            saleService.searchSalesDetails([search, search])
                .then(function (sales) {
        ...
        saleData.forEach(function (item, index) {
            ...
            dataService.getPurchasesByProduct([p_id], function (err, purchasesFromDB) {
                ...
                if (firstTrack === 0) {
                    ...
                    dataService.addSaleAndDetails(insertSale, saleDetailsToAdd)
                        .then(function (rows) {
