...
exports.verifyAndLogIn = function (req, res, next) {
    ...
    req.services(function (err, services) {
        ...
        loginService.getUser([usernameInput], function (err, user) {
            ...
            userIsSuper = userIsAdmin ? userDetails.admin_role==="superuser" : false;
            console.log("LOGGING IN: ADMIN TYPE, ", userDetails.admin_role);
            console.log("LOGGING IN: USER IS ADMIN, ", userIsAdmin);
            console.log("LOGGING IN: USER IS SUPER, ", userIsSuper);
                ...
                bcrypt.compare(passwordInput, userDetails.password, function (err, match) {
                    ...
                    if (match) {
                        ...
                        req.session.user = {
                            ...
                            superuser: userDetails.admin_role==="superuser",
                        ...
                        if (userIsAdmin) {
                          console.log("User may log in as admin");
                              ...
                              req.session.context = {admin: true, superuser: userIsSuper, user: userDetails.username};
                              if (sessionExpired) {
