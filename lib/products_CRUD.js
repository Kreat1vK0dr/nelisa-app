module.exports = function () {
    ...
    this.show = function (req, res, next) {
      var context, userInSession, userIsAdmin;
      ...
      if (req.session.user && userIsAdmin) {
        ...
        req.getConnection(function (err, connection) {
            connection.query("SELECT p.id p_id, p.description product, c.description category, c.id c_id, p.price price, p.inventory inventory FROM products p, categories c WHERE p.category_id = c.id", function (err, result) {
