...
var getCostAndLogSaleAt = function (date, quantity, singleProductPurchases, updatePurchasesMap) {
    var cost = 0,
...
exports.initialCOSandInventoryLog = function (salesFromDB, purchasesFromDB, salesToUpdate, purchasesToUpdate, inventoryLog) {
    ...
    salesFromDB.forEach(function (sale) {
        ...
        var getSaleDetails = getCostAndLogSaleAt(sale.date, sale.quantity, productPurchases, updateMap);
