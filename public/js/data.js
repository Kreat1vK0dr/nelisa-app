...
//       //  .attr('x',function(d,i){return i * x.rangeBand()/2;})
//        .attr('x',function(d,i){return i * (width/dataset.length)+(width/dataset.length - padding)/2;})
//        .attr('y', function(d){return height - y(d.quantity) + 3; })
//       //  .attr('y', function(d){return height - d.quantity + 11;})
...
console.log("This is x(dataset[0].quantity)",x(dataset[0].product));
      ...
      svg.selectAll(".text")
          ...
          .enter()
          .append('text')
          .attr("x", function(d){return x(d.product) + x.rangeBand()/2; })
          .attr("y", function(d) { return y(d.quantity) + 3; })
          .attr("dy", "1.5em")
          .text(function(d) { return d.quantity; })
          .attr('class','text')
